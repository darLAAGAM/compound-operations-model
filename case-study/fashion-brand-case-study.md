...
| Platform | Shopify (ecommerce), Klaviyo (email/SMS), StockAgile (inventory), Amphora (3PL), Richpanel (CS) |
...
- Connected Shopify, Klaviyo, StockAgile, 3PL API, CS platform, and accounting system
